...
/* forEachTrackマクロ */
#define forEachTrack(pMIDIData, pTrack) for((pTrack)=(pMIDIData)->m_pFirstTrack;(pTrack);(pTrack)=(pTrack)->m_pNextTrack)

/* forEachTrackInverseマクロ */
#define forEachTrackInverse(pMIDIData, pTrack) for((pTrack)=(pMIDIData)->m_pLastTrack;(pTrack);(pTrack)=(pTrack)->m_pPrevTrack)


/* forEachEventマクロ */
#define forEachEvent(pTrack,pEvent) for((pEvent)=(pTrack)->m_pFirstEvent;(pEvent);(pEvent)=(pEvent)->m_pNextEvent)

/* forEachEventInverseマクロ */
#define forEachEventInverse(pTrack,pEvent) for((pEvent)=(pTrack)->m_pLastEvent;(pEvent);(pEvent)=(pEvent)->m_pPrevEvent)
